...
public:
     ...
     *
     * Inicializa uma instância de `DatabaseController` e define o caminho do arquivo com os dados base dos players.
     */
    DatabaseController();
     ...
     *
     * @param playerController Ponteiro para o `PlayerController`, que é utilizado para gerenciar todos os players.
     */
     ...
     *
     * @param playerController Ponteiro para o `PlayerController` que fornece os dados dos players a serem salvos.
     */
