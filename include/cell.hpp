 ...
 *
 * Este arquivo define a classe `Cell`, que representa uma célula individual do tabuleiro de jogo.
 * A classe fornece funcionalidades para gerenciar o estado de uma célula, como o valor armazenado e
 * seu estado de seleção.
 */
#ifndef CELL_H
#define CELL_H
  ...
  * e um estado booleano que indica se a célula já foi selecionada ou não.
  */
class Cell {
private:
    ...
    /**
     * @brief Indica se a célula já foi selecionada ou não.
     *
...
public:
     ...
     *
     * Inicializa a célula com valores padrão 0 e estado de seleção false.
     */
    Cell();
