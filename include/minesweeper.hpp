...
public:
     ...
     * 
     * Inicia o jogo e gerencia o fluxo de jogo entre dois jogadores. O segundo jogador pode ser `nullptr` se apenas
     * um jogador estiver participando. 
     * 
     * @param player1 Ponteiro para o primeiro jogador.
     * @param player2 Ponteiro para o segundo jogador (opcional).
     * @return Ponteiro para o jogador que venceu, ou `nullptr` se não houver vencedor.
     */
