 ...
 * sobre o nome do jogo e suas estatísticas, como o número de vitórias, derrotas e empates, a serem
 * computados pelos players.
 */
#ifndef GAME_H
#define GAME_H
...
#include <string>
 ...
 /**
  * @class Game
  * @brief Representa um jogo e suas estatísticas individuais (número de vitórias, derrotas e empates).
  *
  * A classe `Game` armazena informações sobre um jogo específico, incluindo seu nome e estatísticas
  * relacionadas ao player, como o número de vitórias, derrotas e empates.
  */
class Game {
private:
